...
// 获取上传的 UploadId
function getUploadIds(_self, params, callback) {
	var Bucket = params.Bucket;
	var Region = params.Region;
	var Key = params.Key;
...
function getAllListParts(_self, params, callback) {
	var UploadList = params.UploadList || [];
	params.UploadList = UploadList;

	_self.MultipartList(params, function(err, data) {
		if (err) {
			return callback(err);
		}
		...
		if (data.IsTruncated == 'true') {
			...
			return getAllListParts(_self, params, callback);
		} else {
...
// 获取上传任务的 UploadId
function getUploadId(_self, params, callback) {
	var Bucket = params.Bucket;
	var Region = params.Region;
	var Key = params.Key;
	var StorageClass = params.StorageClass;
...
// 获取特定上传任务的分块列表
function getUploadedParts(_self, params, callback) {
	var Bucket = params.Bucket;
	var Region = params.Region;
	var Key = params.Key;
	...
	_self.MultipartListPart({
		...
		if (data.IsTruncated == 'true') {
			...
			return getUploadedParts(_self, params, callback);
...
*/
function uploadSliceList(_self, params, cb) {
...
// 上传指定分片
function uploadSliceItem(_self, params, callback) {
	var Bucket = params.Bucket;
	var Region = params.Region;
	var Key = params.Key;
	var UploadId = params.UploadId;
...
// 完成分块上传
function uploadSliceComplete(_self, params, callback) {
...
// 批量抛弃分块上传任务
function abortUploadTaskArray(_self, params, callback) {
